...
public class CatUnitTest {
	...
	public void testGetName() {
		// TODO: Fill in
		Assert.assertTrue(c.getName().equals("Jennyanydots"));
	}
	...
	public void testGetRented() {
		// TODO: Fill in
		Assert.assertTrue(c.getRented() == false);
	}
	...
	public void testToString() {
		// TODO: Fill in
		Assert.assertTrue(c.toString().equals("ID 1. Jennyanydots"));
	}
	...
	public void testRentCat() {
		...
		c.rentCat();
		c.getRented();
		Assert.assertTrue(c.getRented() == true);
	}
	...
	public void testRenameCat() {
		...
		Assert.assertTrue(c.getName().equals("Garfield"));
		Assert.assertTrue(c.toString().equals("ID 1. Garfield"));
	}
